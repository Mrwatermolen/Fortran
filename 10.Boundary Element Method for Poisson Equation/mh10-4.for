      program main
        dimension x(5),y(5),G(4,4),gama(4),uq0(4),uq(4)
        x(1)=0.
        y(1)=0.
        x(2)=1.
        y(2)=0.
        ...
        gama(3)=0
        gama(4)=0
        call matrix(4,x,y,gama,uq0,G,uq)
        write(*,20)G,uq
20    format(1x,3d15.6)
          call gauss(4,G,uq)
        do 5 j=1,4
...
5     continue
          write(*,*)(uq0(i),i=1,4)
        write(*,*)(uq(i),i=1,4)
        call inter(4,xd,yd,x,y,uq0,uq,ud)
          write(*,*) xd,yd,ud
        end
    
    
        subroutine matrix(n,x,y,gama,uq0,G,uq)
        dimension x(5),y(5),xm(4),ym(4),H(4,4),G(4,4),uq(4)
        dimension uq0(4),gama(4)
        x(n+1)=x(1)
        y(n+1)=y(1)
        do 10 j=1,n
          xm(j)=0.5*(x(j)+x(j+1))
